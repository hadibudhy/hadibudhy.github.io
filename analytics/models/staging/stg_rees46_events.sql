...
with source_rows as (
    ...
    select
        md5(concat_ws('|', cast(event_time as varchar), cast(event_type as varchar), cast(product_id as varchar), cast(user_id as varchar), coalesce(cast(user_session as varchar), ''), cast(source_row_number as varchar))) as event_id,
