...
**Congestion pricing: KEEP, REDESIGN, PRIVATE.** The official geofence and MTA traffic-entry data improve coarse boundary classification and external validation, but do not solve route-level exposure. The full HVFHV pre/post panel and through-route exposure still need to be completed before publishing a causal estimate. The article remains hidden until that evidence exists.
