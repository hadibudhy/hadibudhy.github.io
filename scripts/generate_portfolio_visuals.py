...
def generate():
    # New project visuals
    bars("portfolio-online-shoppers-segments.svg", "New visitors converted more often in this historical session file", "Revenue=True rate after removing 125 exact duplicate rows; n is the deduplicated session denominator.", ["New visitor · n=1,693", "Returning visitor · n=10,431"], [24.9, 14.1], "Conversion rate (%)", "UCI Online Shoppers Purchasing Intention, 2018", "Descriptive, not causal")
    bars("portfolio-online-shoppers-pagevalue.svg", "PageValues separates sessions sharply—and is unsafe for pre-intervention targeting", "Positive PageValues is a downstream diagnostic; it is not evidence that a prompt caused conversion.", ["PageValues > 0 · n=2,730", "PageValues = 0 · n=9,475"], [56.3, 3.9], "Revenue=True rate (%)", "UCI Online Shoppers Purchasing Intention, 2018", "Leakage warning")
