...
def build_resume() -> None:
    ...
    story.extend([
        ...
        Paragraph('<b>MTA Comparator Audit</b> - Descriptive audit shows why an unstable comparison should not support a congestion-pricing claim. <link href="https://hadibudhy.github.io/projects/mta-congestion-pricing-causal-audit" color="#087E8B">Case study</link>', body),
