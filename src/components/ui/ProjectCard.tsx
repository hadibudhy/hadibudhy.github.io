      ...
      <article className="surface flex h-full min-w-0 flex-col overflow-hidden transition-colors hover:border-primary">
        ...
        <div className="flex min-w-0 w-full flex-1 flex-col justify-between p-5 sm:p-7">
          <div>
            ...
            {meta.result && <div className="break-words border-t border-primary/40 pt-4 text-sm leading-6 text-foreground"><span className="mb-1 block text-[0.65rem] font-bold uppercase tracking-[0.16em] text-primary">Decision signal</span>{meta.result}</div>}
          </div>
