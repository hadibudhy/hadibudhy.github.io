    ...
    <div>
      <section className="border-b border-white/[0.08]">
        <div className="mx-auto max-w-6xl px-4 py-16 sm:px-8 sm:py-20 md:py-28">
          ...
          <h1 className="mt-5 max-w-4xl break-words text-[2.7rem] font-black tracking-[-0.05em] text-foreground sm:text-5xl md:text-7xl">Hadi Budhy makes the path from messy data to a better decision shorter.</h1>
