    ...
    <div>
      <section className="border-b border-white/[0.08]">
        <div className="mx-auto max-w-6xl px-5 py-20 sm:px-8 md:py-28">
          ...
          <h1 className="mt-5 max-w-4xl text-5xl font-black tracking-[-0.05em] text-foreground md:text-7xl">The decisions behind the dashboards, models, and pipelines.</h1>
