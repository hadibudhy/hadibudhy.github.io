...
- **Estimated lift:** 115 additional conversions per 100,000 assigned users.
- **Confidence:** the 95% interval was 0.108–0.122 percentage points; p < 0.001.
...
The treatment group converted at **0.309%** and the control group at **0.194%**. The absolute difference was **0.115 percentage points** (95% CI **0.108–0.122pp**). The relative lift was approximately **59%**, but the absolute lift is better for planning. Visits increased by **1.034 percentage points** (95% CI **1.006–1.063pp**).
...
**P0:** continue only behind an incremental CPA guardrail. **P1:** retest high-response feature bands in a new holdout, with multiple-testing control. **P2:** add internal spend, margin, retention, and complaint outcomes.
...
**30-second explanation:** “I evaluated Criteo’s randomized incrementality benchmark with an intention-to-treat comparison. Advertising lifted conversion by about 0.115 percentage points, or roughly 115 extra conversions per 100,000 assigned users, with a tight confidence interval. I would not call it profitable without cost and contribution data. My recommendation is controlled scale only when incremental CPA stays below contribution value, followed by a fresh holdout for segment targeting.”
