...
**Validation resources:** [View the full metric validation and chart code](https://github.com/hadibudhy/hadibudhy.github.io/blob/master/scripts/generate_chart_replacements.py) · [View the UCI dataset](https://archive.ics.uci.edu/dataset/352/online%2Bretail)
