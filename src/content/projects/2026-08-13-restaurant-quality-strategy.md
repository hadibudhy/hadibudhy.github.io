...
**Validation resources:** [View the full metric validation, bootstrap, and chart code](https://github.com/hadibudhy/hadibudhy.github.io/blob/master/scripts/generate_chart_replacements.py) · [View the NYC Open Data source](https://data.cityofnewyork.us/d/43nn-pn8j)
